...
Neo provides a complete HTTP interface for integration with other software. You can call neo by sending HTTP requests to `127.0.0.1:port`, where `port` is the listening port of neo, default to `60828`, and can be changed in the app settings.
