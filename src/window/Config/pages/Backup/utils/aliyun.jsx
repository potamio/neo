...
export async function accessToken(_code) {
    throw new Error(
        'Aliyun backup via third-party proxy is disabled. Please use Aliyun Open Platform OAuth and your own backend to obtain access_token.'
    );
}
